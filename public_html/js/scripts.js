...
// Map  ------------------
    $("#map-canvas").gmap3({
        ...
        marker: {
            values: [ {
                latLng: [ 44.42427, 26.10616 ],
                data: "Echipa Pure-Mess Design oferă servicii de consultanță, proiectare și execuție mobilier pe comanda, design interior, 3D-uri conform stilului dorit.",
                options: {
