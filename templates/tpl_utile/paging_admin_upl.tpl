...
<form class="form-inline pull-right" role="form" onsubmit="return false;" style="min-width: 400px;">
    ...
    <input type="text" class="form-control input-sm" name="{$nameElemPaging}" id="{$nameElemPaging}" onKeyPress="
                        if(event.keyCode==13) 
                            if(!isFinite(this.value) || parseInt(this.value)!=this.value || this.value=='' || this.value>noPages || this.value<=0)
                                ...
                                window.location=pgUrl+this.value+pgOptions;" style="width: 50px; height: 25px; float: left; margin-left: 5px;">
